...
NodeAttributeNames = ['Parameters', 'Action', 'Observation']

NodeAttributeType = ['Static', 'Input', 'Output']

ParameterNames = ['Screen Resolution X', 'Screen Resolution Y', 'Observation Type']
ParameterTypes = ['int', 'int', 'list']

ParametersDefaultValues = [200, 200, ['Pixels', 'Parameters', 'Everything']]
